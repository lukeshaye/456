            ...
            <div className="grid gap-6 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3">
              {clients.map((client) => (
                ...
                >
                  ...
                  {/* TAREFA 6: Div dos botões corrigida */}
                  <div className="px-6 py-3 bg-gray-50 border-t border-gray-200 flex items-center justify-start gap-3">
                    <button
                    ...
                    {client.phone && (
                      <button
                        ...
                        className="inline-flex items-center justify-center px-3 py-2 border border-green-300 shadow-sm text-sm font-medium rounded-md text-green-700 bg-white hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                      >
