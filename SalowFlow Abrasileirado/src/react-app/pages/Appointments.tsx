                ...
                <form onSubmit={handleSubmit(onSubmit as any)}>
                  ...
                  <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                     {editingAppointment && (
                        ...
                        className="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:mr-auto sm:w-auto sm:text-sm"
                        >
                        Excluir
                        </button>
                    )}
