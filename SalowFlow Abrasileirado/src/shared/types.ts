...
// NOVO: Schema específico para o formulário de agendamento.
// Ele remove a validação do `client_name`, pois esse campo é adicionado
// programaticamente na função onSubmit, e não existe no formulário.
